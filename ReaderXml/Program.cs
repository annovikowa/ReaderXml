...
namespace ReaderXml
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var kpt = CadastralPlanTerritoryFactory.Create(@"D:\ReaderXml\ReaderXml\КПТ\Примеры\KPT (v10)\50_48_0000000_2016-06-29_kpt10.xml");
            //TODO заменить на абстрактные классы.
