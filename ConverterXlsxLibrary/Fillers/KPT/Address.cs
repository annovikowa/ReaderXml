...
namespace ConverterXlsxLibrary.Fillers.KPT
{
    ...
    public class Address
    {
        ...
        public Address(XmlReader reader, Dictionary<string, string> dictionaryRegion, string error)
        {
            try
            {
                while (reader.Read())
    ...
    public class Location
    {
        ...
        public Location(XmlReader reader, Dictionary<string, string> dictionaryRegion, string error)
        {
            try
            {
                while (reader.Read())
                            ...
                            case "Elaboration":
                                {
                                    ...
                                    Elaboration = new Elaboration(inner, error);
                                    inner.Close();
                                }
                                break;
                            case "Address":
                                {
                                    var inner = reader.ReadSubtree();
                                    Address = new Address(inner, dictionaryRegion, error);
                                    inner.Close();
                                }
                                break;
                            default:
    ...
    public class Elaboration
    {
        ...
        public Elaboration(XmlReader reader, string error)
        {
            try
            {
                while (reader.Read())
